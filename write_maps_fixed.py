...
ILLINOIS_WRITE_MAP = [
    ...
    # H3615 - Kindred
    {"client_id": "H3615", "plan": "EPO", "label": "Kindred EPO", "block_id": "ILL_KIN_EPO",
     "cells": {"EE Only": "D25", "EE+Spouse": "D26", "EE+Child(ren)": "D27", "EE+Family": "D28"}},
    {"client_id": "H3615", "plan": "VALUE", "label": "Kindred VALUE", "block_id": "ILL_KIN_VAL",
     "cells": {"EE Only": "D37", "EE+Spouse": "D38", "EE+Child(ren)": "D39", "EE+Family": "D40"}},
    
    # H3625 - West Suburban
    {"client_id": "H3625", "plan": "EPO", "label": "West Suburban EPO", "block_id": "ILL_WS_EPO",
     "cells": {"EE Only": "D47", "EE+Spouse": "D48", "EE+Child(ren)": "D49", "EE+Family": "D50"}},
    {"client_id": "H3625", "plan": "VALUE", "label": "West Suburban VALUE", "block_id": "ILL_WS_VAL",
     "cells": {"EE Only": "D59", "EE+Spouse": "D60", "EE+Child(ren)": "D61", "EE+Family": "D62"}},
    
    # H3630 - East Suburban
    {"client_id": "H3630", "plan": "EPO", "label": "East Suburban EPO", "block_id": "ILL_ES_EPO",
     "cells": {"EE Only": "D69", "EE+Spouse": "D70", "EE+Child(ren)": "D71", "EE+Family": "D72"}},
    {"client_id": "H3630", "plan": "VALUE", "label": "East Suburban VALUE", "block_id": "ILL_ES_VAL",
     "cells": {"EE Only": "D81", "EE+Spouse": "D82", "EE+Child(ren)": "D83", "EE+Family": "D84"}},
    
    # H3635 - Downtown
    {"client_id": "H3635", "plan": "EPO", "label": "Downtown EPO", "block_id": "ILL_DT_EPO",
     "cells": {"EE Only": "D91", "EE+Spouse": "D92", "EE+Child(ren)": "D93", "EE+Family": "D94"}},
    {"client_id": "H3635", "plan": "VALUE", "label": "Downtown VALUE", "block_id": "ILL_DT_VAL",
     "cells": {"EE Only": "D103", "EE+Spouse": "D104", "EE+Child(ren)": "D105", "EE+Family": "D106"}},
    
    # H3645 - North Central  
    {"client_id": "H3645", "plan": "EPO", "label": "North Central EPO", "block_id": "ILL_NC_EPO",
     "cells": {"EE Only": "D113", "EE+Spouse": "D114", "EE+Child(ren)": "D115", "EE+Family": "D116"}},
    {"client_id": "H3645", "plan": "VALUE", "label": "North Central VALUE", "block_id": "ILL_NC_VAL",
     "cells": {"EE Only": "D125", "EE+Spouse": "D126", "EE+Child(ren)": "D127", "EE+Family": "D128"}},
    
    # H3655 - South Shore
    {"client_id": "H3655", "plan": "EPO", "label": "South Shore EPO", "block_id": "ILL_SS_EPO",
     "cells": {"EE Only": "D135", "EE+Spouse": "D136", "EE+Child(ren)": "D137", "EE+Family": "D138"}},
    {"client_id": "H3655", "plan": "VALUE", "label": "South Shore VALUE", "block_id": "ILL_SS_VAL",
     "cells": {"EE Only": "D147", "EE+Spouse": "D148", "EE+Child(ren)": "D149", "EE+Family": "D150"}},
    
    # H3660 - Midwest
    {"client_id": "H3660", "plan": "EPO", "label": "Midwest EPO", "block_id": "ILL_MW_EPO",
     "cells": {"EE Only": "D157", "EE+Spouse": "D158", "EE+Child(ren)": "D159", "EE+Family": "D160"}},
    {"client_id": "H3660", "plan": "VALUE", "label": "Midwest VALUE", "block_id": "ILL_MW_VAL",
     "cells": {"EE Only": "D169", "EE+Spouse": "D170", "EE+Child(ren)": "D171", "EE+Family": "D172"}},
    
    # H3665 - Prairie
    {"client_id": "H3665", "plan": "EPO", "label": "Prairie EPO", "block_id": "ILL_PR_EPO",
     "cells": {"EE Only": "D179", "EE+Spouse": "D180", "EE+Child(ren)": "D181", "EE+Family": "D182"}},
    {"client_id": "H3665", "plan": "VALUE", "label": "Prairie VALUE", "block_id": "ILL_PR_VAL",
     "cells": {"EE Only": "D191", "EE+Spouse": "D192", "EE+Child(ren)": "D193", "EE+Family": "D194"}},
    
    # H3670 - River North
    {"client_id": "H3670", "plan": "EPO", "label": "River North EPO", "block_id": "ILL_RN_EPO",
     "cells": {"EE Only": "D201", "EE+Spouse": "D202", "EE+Child(ren)": "D203", "EE+Family": "D204"}},
    {"client_id": "H3670", "plan": "VALUE", "label": "River North VALUE", "block_id": "ILL_RN_VAL",
     "cells": {"EE Only": "D213", "EE+Spouse": "D214", "EE+Child(ren)": "D215", "EE+Family": "D216"}},
    
    # H3675 - Lakeview
    {"client_id": "H3675", "plan": "EPO", "label": "Lakeview EPO", "block_id": "ILL_LV_EPO",
     "cells": {"EE Only": "D223", "EE+Spouse": "D224", "EE+Child(ren)": "D225", "EE+Family": "D226"}},
    {"client_id": "H3675", "plan": "VALUE", "label": "Lakeview VALUE", "block_id": "ILL_LV_VAL",
     "cells": {"EE Only": "D235", "EE+Spouse": "D236", "EE+Child(ren)": "D237", "EE+Family": "D238"}},
    
    # H3680 - Lincoln Park
    {"client_id": "H3680", "plan": "EPO", "label": "Lincoln Park EPO", "block_id": "ILL_LP_EPO",
     "cells": {"EE Only": "D245", "EE+Spouse": "D246", "EE+Child(ren)": "D247", "EE+Family": "D248"}},
    {"client_id": "H3680", "plan": "VALUE", "label": "Lincoln Park VALUE", "block_id": "ILL_LP_VAL",
     "cells": {"EE Only": "D257", "EE+Spouse": "D258", "EE+Child(ren)": "D259", "EE+Family": "D260"}}
]
